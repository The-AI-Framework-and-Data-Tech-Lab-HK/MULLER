...
# Source: https://github.com/activeloopai/deeplake/blob/94c5e100292c164b80132baf741ef233dd41f3d7/hub/core/tiling/deserialize.py
#
...
def coalesce_tiles(
    ...
    Args:
        ...
        sample_shape (Optional, Tuple[int, ...]): Shape of the output array.
            The sum of all actual tile shapes are expected to be equal to this.
