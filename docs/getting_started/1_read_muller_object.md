...
- For the complete list of input parameters, supported file types, and usage details of `muller.read()`, please refer to the [API documentation](../api/top-level-functions.md#mullerread).
